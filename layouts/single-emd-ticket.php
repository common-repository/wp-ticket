...
<div class="ticket-wrap">
	...
	<div class="ticket-well well">
		<div class="row emd-buffer">
			...
			<div class="col-sm-6">
				<div class="row">
					<div class="col-sm-6">
						<strong><?php esc_html_e('Ticket ID', 'wp-ticket-com'); ?>:</strong>
					</div>
					<div class="col-sm-6">
			...
			<div class="col-sm-6">
				<div class="row">
					<div class="col-sm-6">
						<strong><?php esc_html_e('Priority', 'wp-ticket-com'); ?>:</strong>
					</div>
					<div class="col-sm-6">
		...
		<div class="row emd-buffer">
			...
			<div class="col-sm-6">
				<div class="row">
					<div class="col-sm-6">
						<strong><?php esc_html_e('Topic', 'wp-ticket-com'); ?>:</strong>
					</div>
					<div class="col-sm-6">
			...
			<div class="col-sm-6">
				<div class="row">
					<div class="col-sm-6">
						<strong><?php esc_html_e('Status', 'wp-ticket-com'); ?>:</strong>
					</div>
					<div class="col-sm-6">
	...
	<div class="ticket-inner">
		...
		<div class="row emd-buffer">
			<div class="col-sm-6">
				<strong><?php esc_html_e('First Name', 'wp-ticket-com'); ?>:</strong>
			</div>
			<div class="col-sm-6">
		...
		<div class="row emd-buffer">
			<div class="col-sm-6">
				<strong><?php esc_html_e('Last Name', 'wp-ticket-com'); ?>:</strong>
			</div>
			<div class="col-sm-6">
		...
		<div class="row emd-buffer">
			<div class="col-sm-6">
				<strong><?php esc_html_e('Due', 'wp-ticket-com'); ?>:</strong>
			</div>
			<div class="col-sm-6">
		...
		<div class="row emd-buffer">
			<div class="col-sm-6">
				<strong><?php esc_html_e('Attachments', 'wp-ticket-com'); ?>:</strong>
			</div>
			<div class="col-sm-6">
				<?php
	add_thickbox();
