...
<fieldset>
<legend><?php esc_html_e( 'Register', 'wp-ticket-com' ); ?></legend>
...
<label for="emd_user_login"><span><?php esc_html_e('Username', 'wp-ticket-com' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Username field is required','wp-ticket-com');?>" id="req_user_login" class="helptip">
...
<div class="emd-form-field emd-col emd-md-12 emd-sm-12 emd-xs-12 emd-reg">
<div class="emd-form-group emd-login-username">
<label for="emd-user-email"><span><?php esc_html_e('Email', 'wp-ticket-com' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Email field is required','wp-ticket-com');?>" id="req_user_login" class="helptip">
<span class="field-icons required" aria-required="true"></span></a>
</span>
</label>
...
<div class="emd-form-field emd-col emd-md-12 emd-sm-12 emd-xs-12 emd-reg">
<div class="emd-form-group emd-login-username">
<label for="emd-user-fname"><span><?php esc_html_e('First Name', 'wp-ticket-com' ); ?></span>
</label>
...
<div class="emd-form-field emd-col emd-md-12 emd-sm-12 emd-xs-12 emd-reg">
<div class="emd-form-group emd-login-username">
<label for="emd-user-lname"><span><?php esc_html_e('Last Name', 'wp-ticket-com' ); ?></span>
</label>
...
<div class="emd-form-field emd-col emd-md-12 emd-sm-12 emd-xs-12 emd-reg">
<div class="emd-form-group emd-login-username">
<label for="emd-user-pass"><span><?php esc_html_e('Password', 'wp-ticket-com' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Password field is required','wp-ticket-com');?>" id="req_user_login" class="helptip">
<span class="field-icons required" aria-required="true"></span></a>
</span>
</label>
...
<div class="emd-form-field emd-col emd-md-12 emd-sm-12 emd-xs-12 emd-reg">
<div class="emd-form-group emd-login-username">
<label for="emd-user-pass2"><span><?php esc_html_e('Confirm Password', 'wp-ticket-com' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Confirm Password field is required','wp-ticket-com');?>" id="req_user_login" class="helptip">
<span class="field-icons required" aria-required="true"></span></a>
</span>
</label>
...
<input type="submit" id="emd-register-submit" class="emd_submit button" name="emd_register_submit" value="<?php esc_html_e( 'Register', 'wp-ticket-com' ); ?>"/>
</div>
<div style="clear:both">
<p class="emd-login-link" style="float:right">
<a href="">
<?php esc_html_e( 'Login', 'wp-ticket-com' ); ?>
</a>
</p>
</div>
