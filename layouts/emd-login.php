...
<fieldset>
<legend><?php esc_html_e( 'Log into Your Account', 'wp-ticket-com' ); ?></legend>
...
<label for="emd_user_login"><span><?php esc_html_e( 'Username or Email', 'wp-ticket-com' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Username or Email field is required','wp-ticket-com');?>" id="req_user_login" class="helptip">
...
<label for="emd_user_pass"><span><?php esc_html_e( 'Password', 'wp-ticket-com' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Password field is required','wp-ticket-com');?>" id="req_user_pass" class="helptip">
...
<label><input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php esc_html_e( 'Remember Me', 'wp-ticket-com' ); ?></label>
</div>
<div>
...
<input type="submit" class="emd_submit button" id="emd-login-submit" value="<?php esc_html_e( 'Log In', 'wp-ticket-com' ); ?>"/>
</div>
<div style="clear:both">
<p class="emd-lost-password" style="float:left">
<a href="<?php echo wp_lostpassword_url(); ?>">
<?php esc_html_e( 'Lost Password?', 'wp-ticket-com' ); ?>
</a>
</p>
<p class="emd-register-link" style="float:right">
<a href="">
<?php esc_html_e( 'Register', 'wp-ticket-com' ); ?>
</a>
</p>
</div>
