...
global $support_tickets_count, $support_tickets_filter, $support_tickets_set_list;
$real_post = $post;
$ent_attrs = get_option('wp_ticket_com_attr_list');
?>
<tr>
<?php if (emd_is_item_visible('ent_ticket_id', 'wp_ticket_com', 'attribute', 1)) { ?>
<td class="search-results-row"><a href="<?php echo esc_url(get_permalink()); ?>" target="_blank"><?php echo esc_html(emd_mb_meta('emd_ticket_id')); ?>
</a></td>
<?php
} ?>
...
<td class="search-results-row"><?php echo get_the_modified_date('Y-m-d'); ?></td>
</tr>