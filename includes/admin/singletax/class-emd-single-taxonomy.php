...
class Emd_Single_Taxonomy {
	...
	?>
			...
			<li class="hide-if-no-js"><a href="#<?php echo esc_attr($taxonomy); ?>-pop" tabindex="3"><?php esc_html_e('Most Used', 'wp-ticket-com'); ?></a></li>
			</ul>
			<style>
	...
	?>
		...
		<?php
			...
			<?php
				...
				printf(__('+ %s','wp-ticket-com') , $tax->labels->add_new_item);
	?>
			</a>
			</h4>
