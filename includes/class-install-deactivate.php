...
<div class="updated">
<?php
				printf('<p><a href="%1s" target="_blank"> %2$s </a>%3$s<a style="float:right;" href="%4$s"><span class="dashicons dashicons-dismiss" style="font-size:15px;"></span>%5$s</a></p>', 'https://docs.emdplugins.com/docs/wp-ticket-community-documentation/?pk_campaign=wpticket&amp;pk_source=plugin&amp;pk_medium=link&amp;pk_content=notice', __('New To WP Ticket? Review the documentation!', 'wp-ticket-com') , __('&#187;', 'wp-ticket-com') , esc_url(add_query_arg($this->option_name . '_adm_notice1', true)) , __('Dismiss', 'wp-ticket-com'));
?>
</div>
<?php
			}
...
<div class="updated">
<?php
				printf('<p><a href="%1s" target="_blank"> %2$s </a>%3$s<a style="float:right;" href="%4$s"><span class="dashicons dashicons-dismiss" style="font-size:15px;"></span>%5$s</a></p>', 'https://emdplugins.com/plugins/wp-ticket-wordpress-plugin/?pk_campaign=wpticket&amp;pk_source=plugin&amp;pk_medium=link&amp;pk_content=notice', __('Get More Features You Need to Provide the Best Customer Support!', 'wp-ticket-com') , __('&#187;', 'wp-ticket-com') , esc_url(add_query_arg($this->option_name . '_adm_notice2', true)) , __('Dismiss', 'wp-ticket-com'));
?>
</div>
<?php
			}
			if (current_user_can('manage_options') && get_option($this->option_name . '_setup_pages') == 1) {
				echo "<div id=\"message\" class=\"updated\"><p><strong>" . esc_html__('Welcome to Wp Ticket', 'wp-ticket-com') . "</strong></p>
