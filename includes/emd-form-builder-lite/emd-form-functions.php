	...
	elseif($fields['shc'] == 'adv_table'){
		if($type == 'header'){
			...
			if($fields['adv_table']['adv_show_export']){
				...
				<li data-type="">
				<a href="#"><i class="fa fa-fw fa-check"></i>' . __('Current Page', 'wp-ticket-com') . '</a>
				</li>
				<li data-type="all">
				<a href="#"><i class="fa fa-fw"></i>' . __('All', 'wp-ticket-com') . '</a>
				</li>
				<li data-type="selected">
				<a href="#"><i class="fa fa-fw"></i>' . __('Selected', 'wp-ticket-com') . '</a>
				</li>
				</ul>';
			}
			$ret .= '</div>
