...
class P2P_Box {
	...
	public function init_scripts() {
		...
		wp_localize_script( 'p2p-box', 'P2PAdmin', array(
			...
			'deleteConfirmMessage' => __( 'Are you sure you want to delete all connections?', 'wp-ticket-com' ),
	...
	protected function render_create_connections( $post ) {
		...
		$data['tabs'][] = array(
			'tab-id' => 'search',
			'tab-title' => __( 'Search', 'wp-ticket-com' ),
	...
	protected function post_rows( $current_post_id, $page = 1, $search = '' ) {
		...
		if ( $candidate->total_pages > 1 ) {
			$data['navigation'] = array(
				...
				'prev-label' =>  __( 'previous', 'wp-ticket-com' ),
				'next-label' =>  __( 'next', 'wp-ticket-com' ),
				'of-label' => __( 'of', 'wp-ticket-com' ),
			);
		}
