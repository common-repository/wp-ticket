...
if ( ! class_exists( 'EMD_Meta_Box' ) )
{
	...
	class EMD_Meta_Box
	{
		...
		{
			$jqvalid_msg['required'] = __('This field is required.','wp-ticket-com');
			$jqvalid_msg['remote'] = __('Please fix this field.','wp-ticket-com');
			$jqvalid_msg['email'] = __('Please enter a valid email address.','wp-ticket-com');
			$jqvalid_msg['url'] = __('Please enter a valid URL.','wp-ticket-com');
			$jqvalid_msg['date'] = __('Please enter a valid date.','wp-ticket-com');
			$jqvalid_msg['dateISO'] = __('Please enter a valid date ( ISO )','wp-ticket-com');
			$jqvalid_msg['number'] = __('Please enter a valid number.','wp-ticket-com');
			$jqvalid_msg['digits']= __('Please enter only digits.','wp-ticket-com');
			$jqvalid_msg['creditcard']= __('Please enter a valid credit card number.','wp-ticket-com');
			$jqvalid_msg['equalTo']= __('Please enter the same value again.','wp-ticket-com');
			$jqvalid_msg['maxlength']= __('Please enter no more than {0} characters.','wp-ticket-com');
			$jqvalid_msg['minlength']= __('Please enter at least {0} characters.','wp-ticket-com');
			$jqvalid_msg['rangelength']= __('Please enter a value between {0} and {1} characters long.','wp-ticket-com');
			$jqvalid_msg['range']= __('Please enter a value between {0} and {1}.','wp-ticket-com');
			$jqvalid_msg['max']= __('Please enter a value less than or equal to {0}.','wp-ticket-com');
			$jqvalid_msg['min']= __('Please enter a value greater than or equal to {0}.','wp-ticket-com');
		...
		function show()
		{
			...
			if(isset( $this->validation ) && $this->validation){
				echo '
					...
					summaryMessage : "' . __( 'Please correct the errors highlighted below and try again.', 'wp-ticket-com' ) . '",';
			}
