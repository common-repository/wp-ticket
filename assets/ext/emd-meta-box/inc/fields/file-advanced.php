	...
	class EMD_MB_File_Advanced_Field extends EMD_MB_File_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_localize_script( 'emd-mb-file-advanced', 'emdmbFileAdvanced', array(
				'frameTitle' => __( 'Select Files', 'wp-ticket-com' ),
			) );
		}
		...
		{
			$i18n_title  = apply_filters( 'emd_mb_file_advanced_select_string', _x( 'Select or Upload Files', 'file upload', 'wp-ticket-com' ), $field );
